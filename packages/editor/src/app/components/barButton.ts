/**
 * The shared look of a DocumentBar trigger. Its own module rather than a const on
 * DocumentBar so the launchers can dress themselves without importing the bar that
 * renders them.
 */
