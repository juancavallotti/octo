...
func buildTestFork(t *testing.T, reg *core.BlockRegistry, branches ...types.FlowConfig) *fork {
	t.Helper()
	proc, err := tryBuildBlock(reg, core.BlockDeps{},
		types.BlockConfig{Type: "fork", Settings: types.Settings{"branches": branches}})
	if err != nil {
