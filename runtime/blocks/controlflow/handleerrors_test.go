...
func TestHandleErrorsSkipsErrorPathOnSuccess(t *testing.T) {
	cfg := types.BlockConfig{
		Type:     "handle-errors",
		Name:     "charge",
		Settings: types.Settings{"process": []types.BlockConfig{{Type: "pass"}}, "error": []types.BlockConfig{{Type: "fail"}}}}
	proc := buildHandleErrors(t, testRegistry(), cfg)
...
func TestHandleErrorsValidation(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "missing process", block: types.BlockConfig{Type: "handle-errors", Settings: types.Settings{"error": []types.BlockConfig{{Type: "pass"}}}}},
		{name: "missing error", block: types.BlockConfig{Type: "handle-errors", Settings: types.Settings{"process": []types.BlockConfig{{Type: "pass"}}}}},
		{
			name: "foreign slot",
			block: types.BlockConfig{
				Type:     "handle-errors",
				Settings: types.Settings{"process": []types.BlockConfig{{Type: "pass"}}, "error": []types.BlockConfig{{Type: "pass"}}, "branches": []types.FlowConfig{{Process: []types.BlockConfig{{Type: "pass"}}}}}},
		},
	}
...
func TestBlockErrorUnwrapAndLabel(t *testing.T) {
	...
	be := &core.BlockError{Label: "charge", Err: sentinel}
	...
	msg := mustMessage(t)
	core.SetErrorVariable(msg, "flow-name", be)
	e := errorVar(t, msg)
