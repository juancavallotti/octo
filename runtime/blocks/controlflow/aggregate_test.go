...
func withElection(ctx context.Context, leader bool) context.Context {
	svc := electedServices{fakeServices: fakeServices{Store: newFakeKV()}, leader: leader}
...
func buildAggregate(t *testing.T, cfg types.BlockConfig) (*aggregate, *recordingContinuation) {
	...
	proc, err := tryBuildBlock(testRegistry(), core.BlockDeps{}, cfg)
	if err != nil {
...
func TestAggregateAppendsUnpositionedMessagesInArrivalOrder(t *testing.T) {
	ctx, _ := withFakeServices(context.Background())
	block, cont := buildAggregate(t, types.BlockConfig{
		Settings: types.Settings{"correlation": `"events"`, "completionSize": "3"}})
...
func TestAggregateLeavesAGapForAMissingElement(t *testing.T) {
	...
	block, cont := buildAggregate(t, types.BlockConfig{Settings: types.Settings{"completionTimeout": "10ms"}})
...
func TestAggregateCompletionSizeAsAConstant(t *testing.T) {
	ctx, _ := withFakeServices(context.Background())
	block, cont := buildAggregate(t, types.BlockConfig{
		Settings: types.Settings{"correlation": `"batch"`, "completionSize": "2"}})
...
func TestAggregateCompletionExpressionSeesTheGroup(t *testing.T) {
	ctx, _ := withFakeServices(context.Background())
	block, cont := buildAggregate(t, types.BlockConfig{
		Settings: types.Settings{"correlation": `"orders"`, "completionExpression": "vars.group.count >= 2 && vars.group.acc.size() >= 2"}})
...
func TestAggregateExpressionStrategyFolds(t *testing.T) {
	ctx, _ := withFakeServices(context.Background())
	block, cont := buildAggregate(t, types.BlockConfig{Settings: types.Settings{
...
func TestAggregateAbsorbsTheMessageAndBuildsAResponse(t *testing.T) {
	...
	proc, err := tryBuildBlock(reg, core.BlockDeps{}, types.BlockConfig{
		Type:     blockKindAggregate,
		Settings: types.Settings{"buildResponse": &response}})
	if err != nil {
		t.Fatalf("build aggregate: %v", err)
	}
...
func TestAggregateOverflowPolicies(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			ctx, _ := withFakeServices(context.Background())
			block, cont := buildAggregate(t, types.BlockConfig{Settings: types.Settings{"maxGroups": 1, "onOverflow": tt.onOverflow}})
...
func TestAggregateOverflowReleasesTheOldestGroupWithoutATimeout(t *testing.T) {
	...
	for run := range 8 {
		ctx, _ := withFakeServices(context.Background())
		block, cont := buildAggregate(t, types.BlockConfig{
			Settings: types.Settings{"maxGroups": 3, "onOverflow": aggregateOverflowComplete}})
...
func TestAggregateCapHoldsWhenGroupsOpenConcurrently(t *testing.T) {
	...
	block, _ := buildAggregate(t, types.BlockConfig{
		Settings: types.Settings{"maxGroups": maxGroups, "onOverflow": aggregateOverflowDrop}})
...
func TestAggregateIgnoresAnImplausiblePosition(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			ctx, _ := withFakeServices(context.Background())
			block, cont := buildAggregate(t, types.BlockConfig{
				Settings: types.Settings{"correlation": `"g"`, "completionSize": "2"}})
...
func TestAggregateKeepsAGroupTheContinuationRefuses(t *testing.T) {
	ctx, _ := withFakeServices(context.Background())
	block, _ := buildAggregate(t, types.BlockConfig{Settings: types.Settings{"correlation": `"g"`, "completionSize": "2"}})
...
func TestAggregateDoesNotHoldTheStripeWhileDelivering(t *testing.T) {
	...
	ctx, _ := withFakeServices(context.Background())
	block, _ := buildAggregate(t, types.BlockConfig{Settings: types.Settings{"completionSize": "2"}})
...
func TestAggregateOverflowEvictsAcrossASharedStripe(t *testing.T) {
	...
	ctx, _ := withFakeServices(context.Background())
	block, cont := buildAggregate(t, types.BlockConfig{
		Settings: types.Settings{"maxGroups": 1, "onOverflow": aggregateOverflowComplete}})
...
func TestAggregateStoreKeyDefaultsToTheBlockPath(t *testing.T) {
	explicit, _ := buildAggregate(t, types.BlockConfig{Settings: types.Settings{"storeKey": "order-totals"}})
	...
	if defaulted.StateKey() != "test.aggregate" {
...
func TestAggregateStoreKeyIsolatesTwoBlocks(t *testing.T) {
	ctx, _ := withFakeServices(context.Background())
	first, firstCont := buildAggregate(t, types.BlockConfig{Settings: types.Settings{"storeKey": "one"}})
	second, secondCont := buildAggregate(t, types.BlockConfig{Settings: types.Settings{"storeKey": "two"}})
...
func TestAggregateRejectsBadConfig(t *testing.T) {
	tests := []struct {
		...
		{name: "expression strategy without an expression", cfg: types.BlockConfig{Settings: types.Settings{"strategy": "expression"}}},
		{name: "append strategy with an expression", cfg: types.BlockConfig{Settings: types.Settings{"expression": "body"}}},
		{name: "unknown strategy", cfg: types.BlockConfig{Settings: types.Settings{"strategy": "sideways"}}},
		{name: "unparseable timeout", cfg: types.BlockConfig{Settings: types.Settings{"completionTimeout": "soon"}}},
		{name: "non-positive timeout", cfg: types.BlockConfig{Settings: types.Settings{"completionTimeout": "0s"}}},
		{name: "unknown timeoutFrom", cfg: types.BlockConfig{Settings: types.Settings{"timeoutFrom": "middle"}}},
		{name: "unknown onOverflow", cfg: types.BlockConfig{Settings: types.Settings{"onOverflow": "explode"}}},
		{name: "bad correlation expression", cfg: types.BlockConfig{Settings: types.Settings{"correlation": "body."}}},
		{name: "foreign slot", cfg: types.BlockConfig{Settings: types.Settings{"condition": "true"}}},
	}

	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			tt.cfg.Type = blockKindAggregate
			if _, err := tryBuildBlock(testRegistry(), core.BlockDeps{}, tt.cfg); err == nil {
...
func TestAggregateRejectsBeingNested(t *testing.T) {
	err := nestedBuild(types.BlockConfig{Type: blockKindAggregate})
	if err == nil {
