...
// from the block's address, was tried and reverted: see agentSettings.AgentID.
func validateAgentMemoryConfig(cfg agentSettings) error {
...
func (b *builder) configureAgentStore(block *aiAgent, cfg agentSettings) error {
