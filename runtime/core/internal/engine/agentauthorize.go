...
func (b *builder) configureAgentAuthorization(block *aiAgent, cfg types.BlockConfig) error {
...
func (b *builder) agentGates(tools []types.ToolConfig) (map[string]*expr.Program, error) {
...
func (b *builder) configureAuthorizationAnswer(block *aiAgent, cfg types.BlockConfig) error {
...
func (a *aiAgent) answerAuthorization(
	...
	allowed, err := evalCondition(a.authorizeAllow, msg, a.env)
	if err != nil {
