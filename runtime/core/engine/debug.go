...
// are injected by the runtime around an addressed block, never authored in a flow,
// and they are deliberately absent from the schema registry (RegisterBlockMeta):
// nothing that lists the authorable block types may offer them.
