...
* a deployment is lent as much of the platform as it was deployed to reach ([f17079c](https://github.com/juancavallotti/octo/commit/f17079c0e26e04de9166666f4ed0285d495a8b70))
* a deployment is lent as much of the platform as it was deployed to reach ([6a7108d](https://github.com/juancavallotti/octo/commit/6a7108ddd29798bde422a97f5bdb9738d131e50f))
* a deployment's own identity, and one place that decides what a run acts as ([cf9a2ea](https://github.com/juancavallotti/octo/commit/cf9a2ea62ede091548ee93232c8d4395cf73e736))
* **agent:** Dr. Octo spends the token of whoever is chatting ([84eff98](https://github.com/juancavallotti/octo/commit/84eff98c1298a4c7f87e0fd85a515297a72e86bd))
* **agent:** spend the caller's token on the observability API ([541fbee](https://github.com/juancavallotti/octo/commit/541fbeec2ad347a45eb0083872851cb7e396d1f8))
* **desktop:** a Settings window for the runtime and updates ([c32066e](https://github.com/juancavallotti/octo/commit/c32066e808ffacbc3c1c1005f311dd69e14c8e1c))
* Dr. Octo is installed able to do the job he is installed for ([af6bb89](https://github.com/juancavallotti/octo/commit/af6bb8930c5231831f83549aaa3152b3a47bc749))
* **editor:** a callout component, and save failures go to the problems tab ([759e3c7](https://github.com/juancavallotti/octo/commit/759e3c727b06a4e1775c0925fc447023e373744a))
* **editor:** add components from a Cmd+/ palette ([958aa4e](https://github.com/juancavallotti/octo/commit/958aa4ef2321a3ce70c5888a2ae67741b3fca854))
* **editor:** CEL completion that knows where the caret is ([effa89c](https://github.com/juancavallotti/octo/commit/effa89cbdc574d737abf7618bc7347d92c176417))
* **editor:** Cmd+Enter runs, Cmd+. stops ([60be200](https://github.com/juancavallotti/octo/commit/60be200939fd973c9c1d4421c5876bbcb7f25aaa))
* **editor:** complete the body a source says it will send ([d4dcb34](https://github.com/juancavallotti/octo/commit/d4dcb34246d22bc3e781bb559efac93d3ee97043))
* **editor:** learn message shapes from every flow run ([a6ede21](https://github.com/juancavallotti/octo/commit/a6ede2163b1a3326ce6a96a2a868aba9847ee140))
* **editor:** learn message shapes from the tests you run ([1f307af](https://github.com/juancavallotti/octo/commit/1f307afb5ed1849e30f191ead2ce952648c607ce))
* **editor:** read CEL scope from mocks, inputs and test suites ([3d67877](https://github.com/juancavallotti/octo/commit/3d67877dbe6b6b7d163edb61f4281a41b0a0eb34))
* **editor:** read the body a flow states outright ([7602b03](https://github.com/juancavallotti/octo/commit/7602b0311cf840582f4e785dea16305eb95c6b7a))
* **editor:** run pure flows unasked to learn their message shapes ([c7b70cf](https://github.com/juancavallotti/octo/commit/c7b70cf633bd747b36d0f5fc55b193f375633c4e))
* **editor:** run pure flows unasked to learn their message shapes ([a3e8bd4](https://github.com/juancavallotti/octo/commit/a3e8bd418dde3562345dee0b1ee96db32ea3d9ef))
* **editor:** undo and redo on the document bar ([65addf4](https://github.com/juancavallotti/octo/commit/65addf46561e00ec614f8203867318eb42638f32))
* **editor:** undo, redo, and keyboard selection commands ([c2265d0](https://github.com/juancavallotti/octo/commit/c2265d01fb6d9feeee3712d66eaa3b1c76c7105d))
* **helm:** deploy the iam service ([e1dbf6b](https://github.com/juancavallotti/octo/commit/e1dbf6b48a3eb6a10b9fb0960ea00fce142cb42d))
* **helm:** give the platform iam's address and iam the accepted audiences ([52281ca](https://github.com/juancavallotti/octo/commit/52281caccdf9d4d72c4be0c05ecc2a3ad16227b9))
* **helm:** single sign-on is not optional ([ef875a3](https://github.com/juancavallotti/octo/commit/ef875a38c39184abcf45d2566441671b7a4aad04))
* **http:** let a request carry headers and report its status ([d50cc2d](https://github.com/juancavallotti/octo/commit/d50cc2d73e45184caafe6a12aab26a4c6948fffc))
* **iam:** a machine token renews however long ago it expired ([3200b33](https://github.com/juancavallotti/octo/commit/3200b33e87b5eedf889bd51e173be33b75556ca2))
* **iam:** a self-rotating signing keyset published as JWKS ([c5d3693](https://github.com/juancavallotti/octo/commit/c5d3693d80d517de97ac79e225dc85688dbab53a))
* **iam:** accept a set of audiences and read the email from userinfo ([101e4df](https://github.com/juancavallotti/octo/commit/101e4df3ec5915460320620e8ed4aaf805ae0b9f))
* **iam:** admit only provisioned users after the first ([3dde916](https://github.com/juancavallotti/octo/commit/3dde916e80cbd3baa3316f52c8e7a401e162764c))
* **iam:** authenticate the user-management routes ([9f6c4b8](https://github.com/juancavallotti/octo/commit/9f6c4b8fc66684321d49c65c562ce4b3a8e76d86))
* **iam:** create, update and delete users ([0f8db98](https://github.com/juancavallotti/octo/commit/0f8db98c4813e97b143ce1710fe4d143a9282813))
* **iam:** encrypt stored signing keys with the platform's existing key ([6994002](https://github.com/juancavallotti/octo/commit/699400245e2dbe37017642c63740c227ade2fa84))
* **iam:** exchange an OIDC token for a platform JWT ([e1f751f](https://github.com/juancavallotti/octo/commit/e1f751f3a69bc3f6a5425f191981a91c6420e0e7))
* **iam:** introduce the identity service module ([cdc02cc](https://github.com/juancavallotti/octo/commit/cdc02cc35bff27bbcaf77ef64c5707cd018a2f46))
* **iam:** mint machine tokens on behalf of a user ([e2a376a](https://github.com/juancavallotti/octo/commit/e2a376a09e4e9b3b2b9db31b4fc5dccb64098672))
* **iam:** own platform users and the roles granted to them ([ac3700e](https://github.com/juancavallotti/octo/commit/ac3700ebb938af721efddab2b46f423b22e725f5))
* **iam:** provision people by address, and discover the subject ([2ae97f8](https://github.com/juancavallotti/octo/commit/2ae97f83b90ac5269f2c56a8f281ec3ac92b5e98))
* **iam:** refresh an expiring platform token within a grace window ([4406a6a](https://github.com/juancavallotti/octo/commit/4406a6ab1b29bdca961a59b94a9968a8e54b11bc))
* **iam:** scaffold the identity service module ([0ed0620](https://github.com/juancavallotti/octo/commit/0ed062098395af5a013af61d4b00149828f64455))
* **iam:** serve the user bootstrap the orchestrator used to ([db07e2c](https://github.com/juancavallotti/octo/commit/db07e2cedcc267c1f7035cbd22d63d51d3b14df9))
* **mcp:** exchange the OAuth access token for a platform token ([8c30685](https://github.com/juancavallotti/octo/commit/8c3068588ef92659c03c880eeb679b0bae79da3e))
* **observability:** authorize every request ([cdf3acc](https://github.com/juancavallotti/octo/commit/cdf3accf7bc459e4cbff4d384e33dcd6c9ae11fa))
* **orchestrator:** a pod it starts holds no capability it was never given ([a6b1428](https://github.com/juancavallotti/octo/commit/a6b1428df5978563636c4ddab14873e2f698e804))
* **orchestrator:** a pod reads its own integration's frozen resources only ([bc32f22](https://github.com/juancavallotti/octo/commit/bc32f2297fe2cfcd7e982eb47fb7aad10f83959f))
* **orchestrator:** ask iam for a deployment's identity ([abd11ff](https://github.com/juancavallotti/octo/commit/abd11fff11d65c4565c09a2289aa23fcbb4b3074))
* **orchestrator:** authorize every request ([85310ec](https://github.com/juancavallotti/octo/commit/85310ec4e22c7b0f3f0f82aaf18f75ed359b9b98))
* **orchestrator:** carry the caller's credential on the request context ([046ed6e](https://github.com/juancavallotti/octo/commit/046ed6e2ce117e45321c4bbdd32983922b73a041))
* **orchestrator:** mount each deployment a token of its own ([115b419](https://github.com/juancavallotti/octo/commit/115b4191429b6a22613b9a8330730e703d6f50da))
* **platform:** a deployment says on its card what it may do and what it is ([93805c5](https://github.com/juancavallotti/octo/commit/93805c567bb330f95fca4a926b4dad34c408d427))
* **platform:** add a person from a dialog, and page the directory ([045781c](https://github.com/juancavallotti/octo/commit/045781c1fd395bd5ac7152e4bc6f6eb61887a685))
* **platform:** default the write roles to everything but monitor ([2c5b596](https://github.com/juancavallotti/octo/commit/2c5b59624df5d51fdbbec663189b3c8a9dbfff1e))
* **platform:** each grant wears its own colour and mark ([508ac2c](https://github.com/juancavallotti/octo/commit/508ac2c4c6d5c219ef15871a28129b89b921f89f))
* **platform:** exchange the sign-in token for a platform token ([1d79006](https://github.com/juancavallotti/octo/commit/1d790061166612ab0d3f81b943cafb464861d180))
* **platform:** expose the caller's roles to client components ([a6c78e0](https://github.com/juancavallotti/octo/commit/a6c78e0948bd9070c28b4910a80767d5822a56f3))
* **platform:** gate the admin section on platform:admin ([5751f4c](https://github.com/juancavallotti/octo/commit/5751f4c520df527555fca5ec9c75546acc0d25b3))
* **platform:** manage users and their roles from the admin section ([2aa1be7](https://github.com/juancavallotti/octo/commit/2aa1be72ef11b06ce1bfdce8eb62c5af65e6049e))
* **platform:** reflect what the caller may do in what the screens offer ([a0d6f8c](https://github.com/juancavallotti/octo/commit/a0d6f8c201feb868867e444b8b3541e349729b46))
* **platform:** require single sign-on ([6650d1e](https://github.com/juancavallotti/octo/commit/6650d1e3f5e8312e998531beb1536cb6b700d74a))
* **platform:** send the caller's platform token to the orchestrator ([d69b77b](https://github.com/juancavallotti/octo/commit/d69b77bab8e9ca2c91bc157b9f8422865606c61b))
* roles are granted in a dialog, and the table says who the provider thinks you are ([98cd1e4](https://github.com/juancavallotti/octo/commit/98cd1e4b14eebd204c562f6ae3a3829059bafb91))
* **runtime:** read the orchestrator token from a file and renew it ([ecba21b](https://github.com/juancavallotti/octo/commit/ecba21b8816c34d8789860df97458b7c25ebb36d))
* **runtime:** renew the orchestrator token at start ([f685aeb](https://github.com/juancavallotti/octo/commit/f685aeb51df415495f9ccc1f1470af29e40fd2f0))
* **runtime:** trace a one-shot invoke, and a whole test suite ([4d37a8f](https://github.com/juancavallotti/octo/commit/4d37a8f1f9b35f0d44f33f2d2ec2c9c0faa5da45))
* **sql:** grant admin to every user that predates the role table ([e29540e](https://github.com/juancavallotti/octo/commit/e29540e78e6bbe02aa485926aac3b7aeee3fbc0a))


### Bug Fixes

* **desktop:** resolve the folder to restart on inside the queue ([42c4885](https://github.com/juancavallotti/octo/commit/42c48850d067ac5478deffbae60908e10e14bc7f))
* **desktop:** run the editor server on the dock-less helper ([b347e76](https://github.com/juancavallotti/octo/commit/b347e762accc152d7343fcfc8348cc554a3d69a9))
* **editor:** a withheld key stays withheld ([af4eef6](https://github.com/juancavallotti/octo/commit/af4eef63c668a170049dbb51794f1b7e666e26cd))
* **editor:** Cmd+/ inserts after the selected component ([ca021bf](https://github.com/juancavallotti/octo/commit/ca021bf5cdc5d74c88bae62d5b2d83af11a1b81a))
* **editor:** Cmd+Enter runs with the caret still in a field ([43619cf](https://github.com/juancavallotti/octo/commit/43619cf7d40b46c3ff8a4c12c2974015a246a922))
* **editor:** complete nested receivers, and say where a shape came from ([77b7789](https://github.com/juancavallotti/octo/commit/77b77894f7d076534aa50946df30a76d4135388c))
* **editor:** re-learn when the input changed, and when a run raced an edit ([b220ea2](https://github.com/juancavallotti/octo/commit/b220ea2ccb58cc31492fced46e68dd6cceb33c68))
* **editor:** the palette ranks by the id you typed, and holds focus ([62d3339](https://github.com/juancavallotti/octo/commit/62d3339d47f142e435526defd34bda029447e641))
* **helm:** one place names the callback origin, and the welcome page says IAM_URL ([5558ca0](https://github.com/juancavallotti/octo/commit/5558ca0c5171655c95d21d49aa5aae88ba8c1dc7))
* **iam:** a deployment's token carries no profile of the person who lent it ([7568bc3](https://github.com/juancavallotti/octo/commit/7568bc3260dd3117cc866bf2de79f3886c2809ce))
* **iam:** a grant refused for the caller's sake does not blame the target ([5fad8d5](https://github.com/juancavallotti/octo/commit/5fad8d55ebce10ced643f6ece59d7b4f0255e584))
* **iam:** a refresh that could not be answered is not a refusal ([5c084a3](https://github.com/juancavallotti/octo/commit/5c084a3f27716b9b7020b9f42ef2b82e2b59a7c1))
* **iam:** carry the refresh failure taxonomy through this branch ([00b71f6](https://github.com/juancavallotti/octo/commit/00b71f60db5d0a8f1b08e980b9448dea496365ed))
* **iam:** decide about the last administrator atomically ([c2734a3](https://github.com/juancavallotti/octo/commit/c2734a3cc7809cc6489a6b75905827ecf6341deb))
* **iam:** only somebody who may deploy can lend a deployment an identity ([6e96891](https://github.com/juancavallotti/octo/commit/6e96891da782c8028764e0d0250b9559380ba285))
* **iam:** six from review — timeouts, discovery under lock, issuer, CI ([d5591bc](https://github.com/juancavallotti/octo/commit/d5591bc174e33f1f02659c0d9b690cfe8a907639))
* **iam:** the refresh grace never worked against a real clock ([88df310](https://github.com/juancavallotti/octo/commit/88df310dee6f121374d0e7669e0e933764db9998))
* **observability:** bound the keyset refresh, check nbf, and mean the env rule ([01f9029](https://github.com/juancavallotti/octo/commit/01f902901adac84643edf0a5e200d8a6a8db16fc))
* **orchestrator:** a deployment gets an identity or the deploy fails ([e882527](https://github.com/juancavallotti/octo/commit/e88252751b651b16cad496e0bc235e2d99f92d42))
* **orchestrator:** a deployment's token opens its own deployment and no other ([d3ffebf](https://github.com/juancavallotti/octo/commit/d3ffebfd22e33cb2f57a5988538654a791fb29a9))
* **orchestrator:** bound the keyset fetch and detach it from the caller ([9a6a3b4](https://github.com/juancavallotti/octo/commit/9a6a3b4362785561c8e52d94cbe3d3b1ec03e2f9))
* **orchestrator:** bound the keyset refresh, and say what a pod actually reads ([47341e0](https://github.com/juancavallotti/octo/commit/47341e07bcbb3396feb06420ab76ca8a511e71d1))
* **orchestrator:** let the routes that authenticate themselves through ([21fa8b8](https://github.com/juancavallotti/octo/commit/21fa8b801ac26ce858e22ab069fca932b41046fe))
* **orchestrator:** name the uid, or the pod does not start at all ([8a02d3b](https://github.com/juancavallotti/octo/commit/8a02d3b735ac452bd4154e981f3a95c3e297546c))
* **orchestrator:** the mounted token has to be readable by the runtime ([71f6e15](https://github.com/juancavallotti/octo/commit/71f6e15ffb922bc805e107044180b9ecdd3b5523))
* **platform:** send the caller's token when reading the agent's status ([77049be](https://github.com/juancavallotti/octo/commit/77049be82f58342009124d1ae37130fbc2d9fe11))
* **platform:** the advanced deploy warnings read as callouts, not as alarms ([54f8766](https://github.com/juancavallotti/octo/commit/54f87668a3c6a7fd3c1fdb27a0ec7425e9a909e7))
* **platform:** the deployment card's pills wrap instead of leaving the card ([58ef2e8](https://github.com/juancavallotti/octo/commit/58ef2e86dab337b43d909198211ba85b04ccb505))
* **platform:** the refusal titles name every role that would have done ([074e50d](https://github.com/juancavallotti/octo/commit/074e50da886b93e36959ae06552e8aa0b8192794))
* **runtime:** the token stays readable while it is being renewed ([92bc76b](https://github.com/juancavallotti/octo/commit/92bc76b9aa74182dfbbd0c2e387946dfb1d22f2a))
* **sql:** the iam signing key private half is encrypted ([9dd7048](https://github.com/juancavallotti/octo/commit/9dd7048536c0a538f3007aa7f78b1a28e4886713))
* **standalone:** notice flow files changed outside the editor ([fe45007](https://github.com/juancavallotti/octo/commit/fe4500753e2ad50950c3a974dca9f86e18ec1c5a))
* **standalone:** the watcher notices .yml flows too ([d5352d9](https://github.com/juancavallotti/octo/commit/d5352d9c79badc0f25c5dca5566a6b074e9bd6fc))


### Refactoring

* **iam:** a signing key verifies what it signed for good ([b3371f9](https://github.com/juancavallotti/octo/commit/b3371f9f7ec71907300738204a6ad8d1d8171131))
* **iam:** drop the refresh grace window ([599f5cf](https://github.com/juancavallotti/octo/commit/599f5cfe351102830df6dd933d2a2f1aec9e59d1))
* **iam:** drop the unauthenticated user bootstrap ([a963782](https://github.com/juancavallotti/octo/commit/a96378244063a2185693d76ab919d083789b3c1d))
* **iam:** slice by feature, not by layer ([b9aaab3](https://github.com/juancavallotti/octo/commit/b9aaab3a9a469348f20d75b46d41fde73775faee))
* **mcp:** drop the API-key branch from the token verifier ([72d1b51](https://github.com/juancavallotti/octo/commit/72d1b51ad2fc86e567830c067ce9e2375d568ad2))
* **orchestrator:** remove the user module ([2f13aa8](https://github.com/juancavallotti/octo/commit/2f13aa85b7048127bfc0cd85a8623480cf52e12c))
* **platform:** one way to reach the observability service ([fc49ea0](https://github.com/juancavallotti/octo/commit/fc49ea09cd14b961616a9b793dd23c31355e5ab9))
* **platform:** one way to reach the orchestrator ([d0b7626](https://github.com/juancavallotti/octo/commit/d0b7626d208aa75d339f18e2c011f7242320d1ec))
* **platform:** point the identity calls at iam ([46e24b9](https://github.com/juancavallotti/octo/commit/46e24b91b1990207f1841c8bc55b792fba96c244))
* **terraform:** single sign-on is not optional ([3005bc8](https://github.com/juancavallotti/octo/commit/3005bc83f27c8dce956d8151e9bc793e6575a12e))


### Documentation

* api keys do not reach the mcp endpoint ([9c13417](https://github.com/juancavallotti/octo/commit/9c13417e1e4494890cde4363361529225151adc2))
* **blocks:** a block documents what it does, not what surrounds it ([b61d83b](https://github.com/juancavallotti/octo/commit/b61d83bc0990e1f0630e639fcf78099d216903dd))
* **blocks:** a block documents what it does, not what surrounds it ([7f64291](https://github.com/juancavallotti/octo/commit/7f642917124ae542e234059de6c0c75620369e0b))
* comments document their own layer, and nothing else ([dfe4611](https://github.com/juancavallotti/octo/commit/dfe46114a6684219eaaec2c2cc7d5859369efabc))
* comments document their own layer, and nothing else ([0a48521](https://github.com/juancavallotti/octo/commit/0a48521ef73d45d7bc1dcc99e76507d9439ddd9a))
* **connectors:** a connector explains itself, not its neighbours ([bfd236a](https://github.com/juancavallotti/octo/commit/bfd236a6d71bd3228a763838f38c37d3fcec35d7))
* **connectors:** a connector explains itself, not its neighbours ([eb1e4fa](https://github.com/juancavallotti/octo/commit/eb1e4fa40de9c38e22e548895a9232b0a68416a4))
* **core:** comments that document core, and not what sits above it ([39c5d14](https://github.com/juancavallotti/octo/commit/39c5d146b588814e8f790f3337d8aa65635cb466))
* **core:** comments that document core, and not what sits above it ([48eef80](https://github.com/juancavallotti/octo/commit/48eef8004fb46dee0038df931ae054c63f79953f))
* **desktop, standalone, packages:** the lower layers stop naming the apps above them ([1919830](https://github.com/juancavallotti/octo/commit/19198304aa8f87f28929a7aa44d2db0327dc0b15))
* **desktop:** comments document the shell, not its packaging history ([f5828cd](https://github.com/juancavallotti/octo/commit/f5828cdbd1eb53405583aed495c3429734dfaace))
* **desktop:** point people at the desktop downloads ([0b9b85e](https://github.com/juancavallotti/octo/commit/0b9b85eed6c163bed236174fe1fcb08514fbed73))
* **desktop:** point people at the desktop downloads ([ecd2445](https://github.com/juancavallotti/octo/commit/ecd2445f8ea84686d55a777d285a98814b8d5006))
* **editor:** comments document the editor, not the apps around it ([601315c](https://github.com/juancavallotti/octo/commit/601315c147e2b9b75b6edbadcf19c7a052f922a6))
* **editor:** document the editor's keyboard shortcuts ([e20e512](https://github.com/juancavallotti/octo/commit/e20e512eb403d04d6dcdcd46294080c5e3ed749c))
* **editor:** the editor stops explaining itself by its hosts ([60bb60f](https://github.com/juancavallotti/octo/commit/60bb60f8d8bc88eab113e8aff184837f24ced6f0))
* **editor:** zoom to fit is !, with the Shift already in it ([2e8b509](https://github.com/juancavallotti/octo/commit/2e8b50923395d726cc6c87b33e9d18536ccdbb1c))
* **iam, sidecars:** stop explaining these modules by what sits around them ([12b6ee2](https://github.com/juancavallotti/octo/commit/12b6ee2479b9833de49da40cfd6fd41007340775))
* **iam:** comments that document iam and not its callers ([87d18c0](https://github.com/juancavallotti/octo/commit/87d18c0ec8ce3c9062e48bf49a3796dcaf4f2837))
* **iam:** document the module, the service and its configuration ([4fa72b0](https://github.com/juancavallotti/octo/commit/4fa72b07e2155f163a4bca602f70d21c7e747e50))
* name the two settings a runtime pod's credential uses ([7056f50](https://github.com/juancavallotti/octo/commit/7056f50c31fb39ae702cb3324e5d2e168303cc93))
* **observability:** comments document their own layer, and nothing else ([0c956f5](https://github.com/juancavallotti/octo/commit/0c956f5cb61024bccf96009f02203e5c33c22533))
* **observability:** comments that document the service, not its rename ([b906f74](https://github.com/juancavallotti/octo/commit/b906f74ecdbda08884e232aad3d1bcb5b098a838))
* **observability:** regenerate the API description from the trimmed comments ([306cfe3](https://github.com/juancavallotti/octo/commit/306cfe31ad63dd8a2692322b229273940a0bb467))
* **orchestrator:** comments document their own layer, and nothing else ([dd77da0](https://github.com/juancavallotti/octo/commit/dd77da0c41ab512a1d7e5f1f642d601330af5af8))
* **orchestrator:** comments that stop narrating incidents and siblings ([1d1f514](https://github.com/juancavallotti/octo/commit/1d1f5142b98609b9e6bea483428c5b80e8ef25f1))
* **orchestrator:** regenerate the API description from the trimmed comments ([881bce2](https://github.com/juancavallotti/octo/commit/881bce2f492dd51361276170f57cd5d6b161ed2d))
* **packages:** the lowest layer stops naming the apps above it ([45c2f50](https://github.com/juancavallotti/octo/commit/45c2f50f45f0a64d059b08723f0978aaf539d5d7))
* **platform:** comments document their own layer, and nothing else ([2477960](https://github.com/juancavallotti/octo/commit/2477960a325f31bd93f322ea7da753d5a00fa2c1))
* **platform:** comments that document their own unit ([ccd22a0](https://github.com/juancavallotti/octo/commit/ccd22a053d08c411be279ebc760766f4adaefb93))
* roles are rows in iam, not an id-token claim ([7e5b7ca](https://github.com/juancavallotti/octo/commit/7e5b7cac6a63665a00c3a8045d02a5fa0ebb163f))
* **runtime:** the remaining packages stop naming their consumers ([39d82dd](https://github.com/juancavallotti/octo/commit/39d82dd5726ecfb2a82ae344c459340206eab77d))
* **runtime:** the remaining packages stop naming their consumers ([7dec5a1](https://github.com/juancavallotti/octo/commit/7dec5a17588db52fa510223b1337534ebaeb75ba))
* **services:** each module documents itself, not its siblings or its caller ([d88d52f](https://github.com/juancavallotti/octo/commit/d88d52fe2cfb8b488871ef0e2d096d56628130a8))
* **services:** each module documents itself, not its siblings or its caller ([79bc515](https://github.com/juancavallotti/octo/commit/79bc51527105f3b96029e19cf638c8b274cbd864))
* **sidecars:** stop explaining a sidecar by what sits around it ([fcbe9ba](https://github.com/juancavallotti/octo/commit/fcbe9ba53d599339cd0032db8dd18da7acfd662a))
* signing in is the only way into the platform ([3102a15](https://github.com/juancavallotti/octo/commit/3102a15b6ff42acb25bf9876bb416b7890c377fc))
* **sql:** say which database access the key encryption is and is not for ([e9d5253](https://github.com/juancavallotti/octo/commit/e9d5253b2ca0e2a72b4413e4eca429ac9fe94828))
* **standalone:** comments stop describing the shells around this app ([5e63c5e](https://github.com/juancavallotti/octo/commit/5e63c5ec53c0a99992d83db05e90fb93933a5677))
* the branch is green, and don't test the supply chain ([6338d53](https://github.com/juancavallotti/octo/commit/6338d53f164401619fa8063efb04e750ae1b9072))
* the repository is the model again ([60562c0](https://github.com/juancavallotti/octo/commit/60562c02209de3f481a52eb0726a4be48d113a37))
* the repository is the model again ([49ed064](https://github.com/juancavallotti/octo/commit/49ed06451bebbcbd8ad343e01a80515d1f68a2d6))
* the write roles no longer default to everybody ([f3dc4ee](https://github.com/juancavallotti/octo/commit/f3dc4eec823c6503035eb416f180464b881cf00a))
* users and roles are owned by iam ([dc3f62f](https://github.com/juancavallotti/octo/commit/dc3f62f622e4cd82de5d6324c4d94b01228ee302))
