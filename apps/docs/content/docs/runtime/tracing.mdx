...
| k8s (`-tags k8s`) | The `internal.traces` NATS subject, consumed by the platform's [log aggregator](/platform/event-bus), which stores each record and prices any model calls. |
