...
Listeners **observe**. One cannot skip or abort a block; a flow runs the same way whether anything is listening or not. A panic propagates into the flow deliberately — the listener is running as part of it.
