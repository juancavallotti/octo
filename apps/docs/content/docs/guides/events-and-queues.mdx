...
<Cards>
  <Card title="Composing Flows" href="/guides/composing-flows" description="The in-process counterpart: flow-ref and sourceless flows." />
  <Card title="Clustering" href="/runtime/clustering" description="How queues and events behave across replicas." />
  <Card title="Platform Event Bus" href="/platform/event-bus" description="The NATS backing on the deployed platform." />
</Cards>
