...
[`dolphin`](/guides/testing-flows) is: it writes a debug config per case, runs it
...
[dolphin suite](/guides/testing-flows) is what stops the next person — or the next
...
scenario to replay. See [Testing flows in the editor](/editor/testing-flows).
