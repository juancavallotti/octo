...
| `verificationToken` | string | No | — | Verifies inbound Notion webhook signatures. Leave it unset to [bootstrap a new subscription](#webhook-verification-handshake); set it once you have the token. |
