...
once — there is no streaming. See [Raw Content and Streaming](/concepts/raw-content)
for how to serve non-JSON payloads and why the payload is always materialized.
