...
<Callout type="info">
Both subjects are consumed by the same [observability service](/platform/observability-api-reference). Traces landed there because they arrive the same way and are queried the same way.
</Callout>
