 ...
 * bump. `onLoaded` is not called there — the fallback is an assumption, not an
 * answer.
 */
export function useDeployOptions(
  ...
  // rather than during render, which React forbids: a discarded render must not
  // leave a mutation behind it.
