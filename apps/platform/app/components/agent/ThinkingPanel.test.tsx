...
describe("ThinkingPanel", () => {
  it("shows nothing at all when there is no reasoning", () => {
    const { container } = render(<ThinkingPanel text="" streaming answered={false} />);
  ...
  it("is open while the model is still thinking", () => {
    render(<ThinkingPanel text="weighing it up" streaming answered={false} />);
  ...
  it("collapses once the answer starts, keeping a size to hint at what is behind it", () => {
    render(<ThinkingPanel text="weighing it up" streaming answered />);
  ...
  it("respects a deliberate choice over the answer arriving", async () => {
    ...
    const { rerender } = render(
      <ThinkingPanel text="weighing it up" streaming answered={false} />,
    );
    ...
    rerender(<ThinkingPanel text="weighing it up" streaming answered />);
    expect(screen.getByText("weighing it up")).toBeTruthy();
  });
